...
example_rule = MappingRule(
    ...
    mapping={          # The mapping dict: spec -> action.
             "desktop left":            Key("win:down, c-left, win:up"),
             "desktop right":           Key("win:down, c-right, win:up"),
             "desktop copy":            Key("c-c"),
             "desktop cut":             Key("c-x"),
             "desktop paste":           Key("c-v"),
            },
    )

# TODO Make clipboard be toggle thing
